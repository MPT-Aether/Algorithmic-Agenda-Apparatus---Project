...
function confirmSchedule() {
    ...
    if (window.currentUser && window.currentUser.type === 'student') {
        ...
        if (typeof showFloatingNotification === 'function') {
            showFloatingNotification('Enrollment Successful!', `You have successfully enrolled in ${selectedSubjects.length} subjects. Please complete the registration form.`, 'success');
        }
        
        // Show completion popup
        const popup = document.getElementById('enrollmentCompletionPopup');
        const countEl = document.getElementById('enrollCompletionCount');
        if (popup) {
